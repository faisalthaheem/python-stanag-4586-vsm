...
class ControllableEntity:
    ...
    def __init__(self, loop, debug_level, station_id, vsm_id, vehicle_id):
        self.__loop = loop
    ...
    def handle_broadcast(self, wrapper, msg):
        ...
        self.respond_21(msg, wrapper)
        self.respond_20(msg, wrapper)
    ...
    def respond_20(self, wrapper, msg):
        ...
        msg20.vehicle_type = 0x00
        msg20.vehicle_sub_type = 00
        msg20.owning_id = 0x00
        ...
        wrapped_reply.wrap_message(1, 0x01, len(msg20_encoded), False)
        encoded_msg = wrapper.encode() + msg20_encoded
